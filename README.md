...
```json
{
  ...
  "USA": {
    ...
    "address_format_mask": "%N %S %I\\n%C, %P %Z",
    "keywords": {
      "street": ["street", "st", "road", "rd", "avenue", "ave"],
      "neighborhood": ["neighborhood", "suburb"],
      "unit": ["apartment", "apt", "unit", "suite"]
    }
  }
}
```
...
- Frozen header row styled with a professional dark navy background.
